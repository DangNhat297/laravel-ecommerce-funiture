    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(assets/media/svg/shapes/abstract-1.svg)">
            ...
            <div class="card-body">
                ...
                <span class="font-weight-bold text-muted font-size-sm">Danh mục sản phẩm</span>
            </div>
            <!--end::Body-->
        </div>
        <!--end::Stats Widget 29-->
    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bg-info card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{ $productCount }}</span>
                <span class="font-weight-bold text-white font-size-sm">Sản phẩm</span>
            </div>
            <!--end::Body-->
        </div>
    </div>
    <div class="col-xl-3">
        ...
        <div class="card card-custom bg-dark card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 text-hover-primary d-block">{{ $reviewCount }}</span>
                <span class="font-weight-bold text-white font-size-sm">Đánh giá</span>
            </div>
            <!--end::Body-->
        </div>
        <!--end::Body-->
    ...
    <div class="col-xl-3">
        ...
        <div class="card card-custom bg-danger card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="font-weight-bold text-white font-size-sm">Người dùng</span>
            </div>
            <!--end::Body-->
        </div>
        <!--end::Stats Widget 31-->
    ...
    <div class="col-xl-4">
        ...
        <div class="card card-custom bg-warning card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{ $postCount }}</span>
                <span class="font-weight-bold text-white font-size-sm">Bài viết</span>
            </div>
            <!--end::Body-->
        </div>
        <!--end::Stats Widget 31-->
    ...
    <div class="col-xl-4">
        ...
        <div class="card card-custom bg-success card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{ $orderCount }}</span>
                <span class="font-weight-bold text-white font-size-sm">Đơn hàng</span>
            </div>
            <!--end::Body-->
        </div>
        <!--end::Stats Widget 31-->
    ...
    <div class="col-xl-4">
        ...
        <div class="card card-custom bg-primary card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 d-block">{{ productPrice($revenue) }}</span>
                <span class="font-weight-bold text-white font-size-sm">Doanh thu</span>
            </div>
            <!--end::Body-->
        </div>
        <!--end::Stats Widget 31-->
