...
@section('title-heading', 'Cập nhật danh mục')
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.post-category.update', $cat->id) }}">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-inline">
                            ...
                            <input type="radio" value="1" name="status" @checked($cat->status == 1)>
                            <span></span>Hiển thị</label>
                            <label class="radio radio-rounded">
                            <input type="radio" value="0" name="status" @checked($cat->status == 0)>
