...
@section('title-heading', 'Thêm danh mục sản phẩm')
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.category.processCreate') }}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-inline">
                            ...
                            <label class="radio radio-rounded">
                            <input type="radio" value="0" name="status" @if(!empty(old()) && old('status') == 0) checked @endif>
